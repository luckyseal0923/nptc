...
if(path) {document.title=(path==='/teacher'?'後臺管理系統':'我的 OSCE 成績')+'｜為國考而訓';const meta=document.createElement('meta');meta.name='robots';meta.content='noindex,nofollow';document.head.append(meta);}
